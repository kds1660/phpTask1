...
CREATE TABLE `films` (
  ...
  `box_office` int(10) UNSIGNED NOT NULL,
...
(3, 'X-Men', 'Bryan Singer', 2000, 75000000, 296300000, 7200, 'action'),
...
INSERT INTO `studio_films` (`id_studio_film`, `id_film`, `id_studio`) VALUES
(1, 1, 1),
(3, 2, 1),
(4, 3, 2),
(5, 4, 2);
...
ALTER TABLE `studio_films`
  ADD PRIMARY KEY (`id_studio_film`),
  ADD UNIQUE KEY `id_film` (`id_film`,`id_studio`),
  ADD KEY `film_key` (`id_film`),
  ADD KEY `studio_key` (`id_studio`);
...
--
-- AUTO_INCREMENT for table `studio_films`
--
ALTER TABLE `studio_films`
  MODIFY `id_studio_film` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `fees`
  ADD CONSTRAINT `actor_key` FOREIGN KEY (`id_actor`) REFERENCES `actors` (`id_actor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `film_key_2` FOREIGN KEY (`id_film`) REFERENCES `films` (`id_film`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `studio_films`
--
ALTER TABLE `studio_films`
  ADD CONSTRAINT `film_key` FOREIGN KEY (`id_film`) REFERENCES `films` (`id_film`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `studio_key` FOREIGN KEY (`id_studio`) REFERENCES `studios` (`id_studio`) ON DELETE CASCADE ON UPDATE CASCADE;
