...
sql1;
$sql[] = <<<sql1
SELECT studios.name as StudioName, count(DISTINCT flm.id_film) as films, count(fs.id_fee) as fees_number, sum(fs.fee) as fees_sum, avg(fs.fee) as fees_avg from studios
